...
80102088:	68 1e 79 10 80       	push   $0x8010791e
...
801041fb:	68 37 7b 10 80       	push   $0x80107b37
...
80104a67:	e8 04 ef ff ff       	call   80103970 <myproc>
    ...
    num = curproc->tf->eax;
80104a6c:	8b 50 18             	mov    0x18(%eax),%edx
    struct proc *curproc = myproc();
80104a6f:	89 c3                	mov    %eax,%ebx
    num = curproc->tf->eax;
80104a71:	8b 42 1c             	mov    0x1c(%edx),%eax

    // 如果系统调用是 read，增加 count
    if (num == SYS_read) {
80104a74:	83 f8 05             	cmp    $0x5,%eax
80104a77:	74 47                	je     80104ac0 <syscall+0x60>
        count++;
    }

    // 如果系统调用是 getreadcount，返回 count
    if (num == SYS_getreadcount) {
80104a79:	83 f8 16             	cmp    $0x16,%eax
80104a7c:	74 32                	je     80104ab0 <syscall+0x50>
        curproc->tf->eax = count;
        return;
    }

    if (num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a7e:	8d 50 ff             	lea    -0x1(%eax),%edx
80104a81:	83 fa 14             	cmp    $0x14,%edx
80104a84:	76 5a                	jbe    80104ae0 <syscall+0x80>
        curproc->tf->eax = syscalls[num]();
    } else {
        cprintf("%d %s: unknown sys call %d\n",
80104a86:	50                   	push   %eax
                curproc->pid, curproc->name, num);
80104a87:	8d 43 6c             	lea    0x6c(%ebx),%eax
        cprintf("%d %s: unknown sys call %d\n",
80104a8a:	50                   	push   %eax
80104a8b:	ff 73 10             	push   0x10(%ebx)
80104a8e:	68 7d 78 10 80       	push   $0x8010787d
80104a93:	e8 08 bc ff ff       	call   801006a0 <cprintf>
        curproc->tf->eax = -1;
80104a98:	8b 43 18             	mov    0x18(%ebx),%eax
80104a9b:	83 c4 10             	add    $0x10,%esp
80104a9e:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
    }
}
...
80104aaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        curproc->tf->eax = count;
80104ab0:	a1 58 3c 11 80       	mov    0x80113c58,%eax
80104ab5:	89 42 1c             	mov    %eax,0x1c(%edx)
}
...
80104abd:	8d 76 00             	lea    0x0(%esi),%esi
        count++;
80104ac0:	83 05 58 3c 11 80 01 	addl   $0x1,0x80113c58
    if (num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ac7:	ba 10 4d 10 80       	mov    $0x80104d10,%edx
        curproc->tf->eax = syscalls[num]();
80104acc:	ff d2                	call   *%edx
80104ace:	89 c2                	mov    %eax,%edx
80104ad0:	8b 43 18             	mov    0x18(%ebx),%eax
80104ad3:	89 50 1c             	mov    %edx,0x1c(%eax)
}
...
80104adf:	90                   	nop
    if (num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ae0:	8b 14 85 a0 78 10 80 	mov    -0x7fef8760(,%eax,4),%edx
80104ae7:	85 d2                	test   %edx,%edx
80104ae9:	74 9b                	je     80104a86 <syscall+0x26>
80104aeb:	eb df                	jmp    80104acc <syscall+0x6c>
...
80104c24:	68 14 79 10 80       	push   $0x80107914
...
80104c3c:	68 13 79 10 80       	push   $0x80107913
...
80104c51:	68 07 79 10 80       	push   $0x80107907
...
80104c6f:	68 16 79 10 80       	push   $0x80107916
80104c74:	e8 07 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c79:	83 ec 0c             	sub    $0xc,%esp
80104c7c:	68 f8 78 10 80       	push   $0x801078f8
...
80104c9e:	e8 7d fc ff ff       	call   80104920 <argint>
...
80104d18:	83 ec 18             	sub    $0x18,%esp
  readcount += 1;
80104d1b:	83 05 5c 3c 11 80 01 	addl   $0x1,0x80113c5c
  if (argint(n, &fd) < 0)
80104d22:	53                   	push   %ebx
80104d23:	6a 00                	push   $0x0
80104d25:	e8 f6 fb ff ff       	call   80104920 <argint>
80104d2a:	83 c4 10             	add    $0x10,%esp
80104d2d:	85 c0                	test   %eax,%eax
80104d2f:	78 5f                	js     80104d90 <sys_read+0x80>
  if (fd < 0 || fd >= NOFILE || (f = myproc()->ofile[fd]) == 0)
80104d31:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104d35:	77 59                	ja     80104d90 <sys_read+0x80>
80104d37:	e8 34 ec ff ff       	call   80103970 <myproc>
80104d3c:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d3f:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80104d43:	85 f6                	test   %esi,%esi
80104d45:	74 49                	je     80104d90 <sys_read+0x80>
  if (argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104d47:	83 ec 08             	sub    $0x8,%esp
80104d4a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d4d:	50                   	push   %eax
80104d4e:	6a 02                	push   $0x2
80104d50:	e8 cb fb ff ff       	call   80104920 <argint>
80104d55:	83 c4 10             	add    $0x10,%esp
80104d58:	85 c0                	test   %eax,%eax
80104d5a:	78 34                	js     80104d90 <sys_read+0x80>
80104d5c:	83 ec 04             	sub    $0x4,%esp
80104d5f:	ff 75 f0             	push   -0x10(%ebp)
80104d62:	53                   	push   %ebx
80104d63:	6a 01                	push   $0x1
80104d65:	e8 06 fc ff ff       	call   80104970 <argptr>
80104d6a:	83 c4 10             	add    $0x10,%esp
80104d6d:	85 c0                	test   %eax,%eax
80104d6f:	78 1f                	js     80104d90 <sys_read+0x80>
  return fileread(f, p, n);
80104d71:	83 ec 04             	sub    $0x4,%esp
80104d74:	ff 75 f0             	push   -0x10(%ebp)
80104d77:	ff 75 f4             	push   -0xc(%ebp)
80104d7a:	56                   	push   %esi
80104d7b:	e8 a0 c2 ff ff       	call   80101020 <fileread>
...
80104d95:	eb ec                	jmp    80104d83 <sys_read+0x73>
...
80104dae:	e8 6d fb ff ff       	call   80104920 <argint>
...
80104dd9:	e8 42 fb ff ff       	call   80104920 <argint>
...
80104dee:	e8 7d fb ff ff       	call   80104970 <argptr>
...
80104e2e:	e8 ed fa ff ff       	call   80104920 <argint>
...
80104eb8:	e8 b3 fa ff ff       	call   80104970 <argptr>
...
80104eff:	e8 dc fa ff ff       	call   801049e0 <argstr>
...
80104f18:	e8 c3 fa ff ff       	call   801049e0 <argstr>
...
8010504f:	e8 8c f9 ff ff       	call   801049e0 <argstr>
...
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 14 79 10 80       	push   $0x80107914
...
801050a8:	68 13 79 10 80       	push   $0x80107913
...
80105102:	e8 59 f5 ff ff       	call   80104660 <memset>
  if (writei(dp, (char *)&de, off, sizeof(de)) != sizeof(de))
...
8010522f:	e8 ac f7 ff ff       	call   801049e0 <argstr>
...
80105248:	e8 d3 f6 ff ff       	call   80104920 <argint>
...
801052e7:	e8 04 f8 ff ff       	call   80104af0 <create>
    if (ip == 0)
...
801053e9:	e8 32 f5 ff ff       	call   80104920 <argint>
  if ((argstr(0, &path)) < 0 ||
...
801053fe:	e8 1d f5 ff ff       	call   80104920 <argint>
      argint(1, &major) < 0 ||
...
80105455:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105458:	e8 13 e5 ff ff       	call   80103970 <myproc>
...
80105531:	e8 ea f3 ff ff       	call   80104920 <argint>
...
80105550:	e8 0b f1 ff ff       	call   80104660 <memset>
...
8010557a:	e8 11 f3 ff ff       	call   80104890 <fetchint>
...
80105598:	e8 33 f3 ff ff       	call   801048d0 <fetchstr>
...
80105601:	e8 6a f3 ff ff       	call   80104970 <argptr>
...
80105627:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105629:	e8 42 e3 ff ff       	call   80103970 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
...
801056c0 <sys_getreadcount>:

int sys_getreadcount(void)
{
  int rc = readcount;
  return rc;
801056c0:	a1 5c 3c 11 80       	mov    0x80113c5c,%eax
801056c5:	c3                   	ret    
...
801058ee:	00 00 ef 
  initlock(&tickslock, "time");
801058f1:	68 59 79 10 80       	push   $0x80107959
...
80105974:	ff 24 85 00 7a 10 80 	jmp    *-0x7fef8600(,%eax,4)
...
80105a55:	68 bc 79 10 80       	push   $0x801079bc
...
80105aa7:	68 64 79 10 80       	push   $0x80107964
...
80105bc3:	68 88 79 10 80       	push   $0x80107988
80105bc8:	e8 d3 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bcd:	83 c4 14             	add    $0x14,%esp
80105bd0:	68 5e 79 10 80       	push   $0x8010795e
...
80105c7c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c7f:	bf 80 7a 10 80       	mov    $0x80107a80,%edi
...
8010696d:	68 88 7a 10 80       	push   $0x80107a88
...
80106b9b:	68 cd 7a 10 80       	push   $0x80107acd
...
80106c00:	68 e7 7a 10 80       	push   $0x80107ae7
...
80106c88:	68 88 7b 10 80       	push   $0x80107b88
...
80106d29:	68 05 7b 10 80       	push   $0x80107b05
...
80106d8b:	68 1d 7b 10 80       	push   $0x80107b1d
...
80106e6c:	68 39 7b 10 80       	push   $0x80107b39
...
80106f3c:	68 4a 7b 10 80       	push   $0x80107b4a
...
80106fb2:	68 54 7b 10 80       	push   $0x80107b54
...
80107087:	68 6e 7b 10 80       	push   $0x80107b6e
